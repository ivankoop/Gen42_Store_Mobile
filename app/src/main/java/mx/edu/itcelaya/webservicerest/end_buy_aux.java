...
public class end_buy_aux {
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/carts";
    ...
    public int getIDCart(){
        ...
        String SampleURL;
        SampleURL = "http://gen-42-shop.000webhostapp.com/api/carts&output_format=JSON&display=full";
        //Log.e("url", SampleURL);
        try {
    ...
    private void postData() {
        WebServiceTask wst = new WebServiceTask( this.context, "Adding...", prestashop_key);
