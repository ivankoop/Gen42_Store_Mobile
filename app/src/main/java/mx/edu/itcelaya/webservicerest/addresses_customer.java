...
public class addresses_customer extends AppCompatActivity {
    ...
    TextView tittle;
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/addresses&output_format=JSON&display=full&filter%5Bid_customer%5D=";
    ...
    public void llenarLista(){
        ...
        String[] tags = {"Company","Adress","Alias","Phone"};
        String aux;
