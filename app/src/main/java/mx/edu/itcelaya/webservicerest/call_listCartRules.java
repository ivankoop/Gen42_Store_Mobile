...
public class call_listCartRules extends AppCompatActivity {
    ...
    ListView lv2;
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/cart_rules&output_format=JSON&display=full";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo.setText("Discount voucher");
    ...
    public void llenarLista1(){
        ...
        String[] tags = {"Discount","Code","Name","Deadline"};
        try {
