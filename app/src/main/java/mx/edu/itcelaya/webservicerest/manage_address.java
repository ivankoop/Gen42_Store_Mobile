...
public class manage_address extends AppCompatActivity {
    private static final String SERVICE_URL = "http://gen-42-shop.000webhostapp.com/api/addresses";
    ...
    private void loadState(String id_country){
        ...
        String SampleURL = "http://gen-42-shop.000webhostapp.com/api/states&output_format=JSON&display=full&filter%5Bid_country%5D="+id_country;
    ...
    private void loadCountries(){
        ...
        String SampleURL = "http://gen-42-shop.000webhostapp.com/api/countries&output_format=JSON&display=full";
        try {
    ...
    public void putData(View vw) {
        if (!checkFill()) {
            Toast.makeText(this, "Complete all fields please.",
                    Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void deleteData(View vw) {
        ...
        WebServiceTask wst = new WebServiceTask(WebServiceTask.DELETE_TASK, this, "Removing...", prestashop_credentials);
