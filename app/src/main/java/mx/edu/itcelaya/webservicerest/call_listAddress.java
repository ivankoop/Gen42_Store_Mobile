...
public class call_listAddress extends AppCompatActivity {
    ...
    ListView lv;
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/addresses?output_format=JSON&display=full";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo.setText("List of Adresse");
    ...
    public void llenarClientes(){
        ...
        String[] tags = {"Company","Alias","ID","Responsible"};
        String aux;
