...
public class manage_products extends AppCompatActivity {
    private static final String SERVICE_URL = "http://gen-42-shop.000webhostapp.com/api/products" ;
    ...
    private void loadSuppliers(){
        ...
        String SampleURL = "http://gen-42-shop.000webhostapp.com/api/suppliers&output_format=JSON&display=full";
        try {
    ...
    public void retrieveSampleData(View vw) {
        if(!txtID.getText().toString().equalsIgnoreCase("")) {
            ...
            WebServiceTask wst = new WebServiceTask(WebServiceTask.GET_TASK, this, "Searching...", prestashop_credentials);
