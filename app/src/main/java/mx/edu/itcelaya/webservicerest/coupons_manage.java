...
public class coupons_manage extends AppCompatActivity {
    ...
    TextView tittle;
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/cart_rules&output_format=JSON&display=full&filter%5Bactive%5D=1";
    ...
    public void llenarLista(){
        ...
        String[] tags = {"Discount","Code","Name","Applicable"};
        String aux;
