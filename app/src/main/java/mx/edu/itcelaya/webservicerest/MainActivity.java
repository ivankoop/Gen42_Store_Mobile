...
public class MainActivity extends AppCompatActivity {
    private static final String SERVICE_URL = "http://gen-42-shop.000webhostapp.com/api/customers" ;
    ...
    private class WebServiceTask extends AsyncTask<String, Integer, String> {
        ...
        public String generaXMLCliente(Boolean nuevo, Integer id, String firstname, String lastname, String email,
            ...
            String format = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    ...
                    "<customer>\n" +
                    ((nuevo == true)?"":("\t<id>%d</id>\n")) +
                    "\t<id_default_group xlink:href=\"http://gen-42-shop.000webhostapp.com/api/groups/3\">3</id_default_group>\n" +
                    "\t<id_lang xlink:href=\"http://gen-42-shop.000webhostapp.com/api/languages/1\">1</id_lang>\n" +
