...
public class row_list_products extends BaseAdapter {
    ...
    private void fillImagesArray() throws ExecutionException, InterruptedException {
        for (abs_Products Product: ProductsList) {//http://tpawluuaronnt2.one/prestashop/prestashop/api/images/products/
            String sUrl = "http://gen-42-shop.000webhostapp.com/api/images/products/" + Product.getId_product() + "/" + Product.getId_image();
            ...
            throws IOException
    {
        ...
        try{
            ...
            String credentials = "IA8WQDU181IIFLN1INFKAK9V8R3F2NYD:";//"RM6FQ7HBHV654CC82SEFUI18ZHX5FAPU:";
