...
public class call_listOrders extends AppCompatActivity {
    ...
    ListView lv;
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/orders&output_format=JSON&display=full";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!getIntent().getStringExtra("id_customer").equalsIgnoreCase("-1")) {
            ...
            titulo.setText("Orders History");
        }else
            titulo.setText("Orders List");
    ...
    public void llenarClientes(){
        ...
        String[] tags = {"Client ID","Full payement","Order ID","Paid out"};
        String buys="";
