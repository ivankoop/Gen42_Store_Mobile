...
public class agregar_cart_rules_manage extends AppCompatActivity {
    String jsonResult;
    String url = "http://gen-42-shop.000webhostapp.com/api/cart_rules";
    ...
    private void loadCustomers(){
        ...
        String SampleURL = "http://gen-42-shop.000webhostapp.com/api/customers&output_format=JSON&display=full";
        try {
