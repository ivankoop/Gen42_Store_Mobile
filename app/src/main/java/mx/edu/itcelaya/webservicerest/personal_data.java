...
public class personal_data extends AppCompatActivity {
    ...
    String url = "http://gen-42-shop.000webhostapp.com/";
    private String id;
    ...
    public void putData(View v){
        ...
        if(bandera) {
            String urlSample = url + "webservice/updCustomer.php?name=" + txtName + "&lastname=" + txtLastName +
            ...
            if (Integer.parseInt(jsonResult) == 1)
                ...
                Snackbar.make(v, "Error updating", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
        }
        else
            Snackbar.make(v, "Minimum of 8 caracters in password!", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
