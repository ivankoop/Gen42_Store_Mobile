...
public class call_login extends AppCompatActivity {
    ...
    String url = "http://gen-42-shop.000webhostapp.com/webservice/login.php" ; //"http://tpawluuaronnt2.one/prestashop/prestashop/misserviciosweb/tienda.php";
    int opc;
    ...
    private void checkUser()  {
        ...
        url="http://gen-42-shop.000webhostapp.com/webservice/login.php";
        if (valido==1){ //(valido==1)
            ...
            Toast.makeText(getApplicationContext(), "Error, not registred",
                    Toast.LENGTH_LONG).show();
        }
