...
public class manage_suppliers extends AppCompatActivity {
    private static final String SERVICE_URL = "http://gen-42-shop.000webhostapp.com/api/suppliers" ;
    private static String prestashop_credentials = "IA8WQDU181IIFLN1INFKAK9V8R3F2NYD"; //"RM6FQ7HBHV654CC82SEFUI18ZHX5FAPU";
    ...
    public void retrieveSampleData(View vw) {
        if(!txtID.getText().toString().equalsIgnoreCase("")) {
            ...
            Snackbar.make(vw, "Enter ID please.", Snackbar.LENGTH_LONG)
    ...
    public void putData(View vw) {
        ...
        if (Name.equals("") || Desc.equals("") || link.equals("")) {
            Snackbar.make(vw, "Complete all fields", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            return;
        }

        WebServiceTask wst = new WebServiceTask(WebServiceTask.PUT_TASK, this, "Updating...", prestashop_credentials);
    ...
    public void deleteData(View vw) {
        ...
        WebServiceTask wst = new WebServiceTask(WebServiceTask.DELETE_TASK, this, "Deleting...", prestashop_credentials);
    ...
    public void postData(View vw) {
        ...
        if (Name.equals("") || Desc.equals("") || Link.equals("")) {
            Snackbar.make(vw, "Complete all fields please.", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            return;
        }

        WebServiceTask wst = new WebServiceTask(WebServiceTask.POST_TASK, this, "Adding...", prestashop_credentials);
    ...
    private class WebServiceTask extends AsyncTask<String, Integer, String> {
        ...
        public String generaXMLCliente(Boolean nuevo, Integer id, String name, String desc, String link) {
            String format = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    ...
                    "<description><language id=\"1\" xlink:href=\"http://gen-42-shop.000webhostapp.com/api/languages/1\">" +
                    "%s</language></description>\n" +
                    "<meta_title><language id=\"1\" xlink:href=\"http://gen-42-shop.000webhostapp.com/api/languages/1\"></language></meta_title>\n" +
                    "<meta_description><language id=\"1\" xlink:href=\"http://gen-42-shop.000webhostapp.com/api/languages/1\"></language></meta_description>\n" +
                    "<meta_keywords><language id=\"1\" xlink:href=\"http://gen-42-shop.000webhostapp.com/api/languages/1\">%s</language></meta_keywords>\n" +
                    "</supplier>\n" +
                    "</prestashop>";
